...
- About Headline: `Italienisches Handwerk. / Münsteraner Seele.`
- About Lead: `Seit über zwanzig Jahren schneidet Mauro Ricardo italienischen Stil in Münster-Nord. Die Schere wird geführt mit der Ruhe eines Handwerks, das in Italien Generationen alt ist.`
- About Portrait-Caption: `Mauro Ricardo`
- Footer Tagline-Zusatz: `Mitten in Münster-Nord.`
...
- Logo aria-label: `Mauro Ricardo, zur Startseite`
